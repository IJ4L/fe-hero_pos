                ...
                <div className="flex flex-col items-start space-y-4">
                    ...
                    <div className="w-screen px-8 md:px-0 md:w-auto flex flex-col xl:flex-row space-y-2 xl:space-y-0 xl:space-x-4">
                        <button
                            ...
                            onClick={() => window.open("https://play.google.com/store/apps/details?id=com.uinam.hero_pos", "_blank")}
                        ...
                        <button
                            ...
                            className="line-through xl:flex xl:items-center bg-secondary text-white font-semibold px-10 py-3 text-md rounded-3xl hover:px-14 transition-all duration-300"
                        >
                            App Store
                        </button>
                    </div>
